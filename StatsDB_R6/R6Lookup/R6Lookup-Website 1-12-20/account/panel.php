...
$url = 'http://'. $_SERVER['HTTP_HOST'] . '/getStats/getPanelStats.php?resultSavedUsers=' . $resultSavedUsersS . '&resultVotedHackers=' . $resultVotedHackersS . '&resultLatestHackers=' . $resultLatestHackersS . '&appcode=809965';

$getUser = json_decode(file_get_contents($url), true);
?>
