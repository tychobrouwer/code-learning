...
class UbiAPI
{
    ...
    private $http_useragent='Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36';
    ...
    private $base_request_url = [
        'uplay' => 'https://public-ubiservices.ubi.com/v1/spaces/5172a557-50b5-4665-b7db-e3f2e8c5041d/sandboxes/OSBOR_PC_LNCH_A/',
        'xbl' => 'https://public-ubiservices.ubi.com/v1/spaces/98a601e5-ca91-4440-b1c5-753f601a2c90/sandboxes/OSBOR_XBOXONE_LNCH_A/',
        'psn' => 'https://public-ubiservices.ubi.com/v1/spaces/05bfb3f7-6c21-4c42-be1f-97a33fb5cf66/sandboxes/OSBOR_PS4_LNCH_A/'
    ];
    ...
    private function generateB64Creds($emailandpassword)
    {
    ...
    private function uplayticket($check = true)
    {
    ...
    private function contructHeaders($additional_headers)
    {
        return array_merge($this->$base_headers, $additional_headers);
    }
...
///////////////////////////////////////////////////////////////////////////////
    ...
    public function getStatsIndex($mode, $input, $platform, $stats)
    {
        ...
        $headers = $this->contructHeaders($add_headers);
        ...
        $profile_id = $result1['profiles'][0]['profileId'];

        $add_headers = [
            'ubi-appid: 39baebad-39e5-4552-8c25-2c9b919064e2',
            'ubi-sessionid: a4df2e5c-7fee-41ff-afe5-9d79e68e8048',
            'authorization: ' . $uplayTicket,
            'Referer: https://www.ubisoft.com/nl-nl/game/rainbow-six/siege/stats/summary' . $profileId
        ];

        $headers = $this->contructHeaders($add_headers);

        $request_url = 'https://public-ubiservices.ubi.com/v1/profiles/' . $profile_id . '/stats/ProgressionClearanceLevel?spaceId=5172a557-50b5-4665-b7db-e3f2e8c5041d';
        ...
        $request_url = $this->base_request_url[$platform] . '/r6karma/players?board_id=pvp_ranked&profile_ids=' . $profile_id . '&region_id=' . $region . '&season_id=-1';
        ...
        $result3 = json_decode(curl_multi_getcontent($ch3), true);
...
///////////////////////////////////////////////////////////////////////////////
    ...
    public function getStatsPlayer($mode, $input, $platform, $season, $region, $stats)
    {
        ...
        foreach ($seasons as $season) {
            ...
            curl_setopt($ch2[$season], CURLOPT_SSL_VERIFYPEER, false);
        }
