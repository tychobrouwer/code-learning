...
if (empty(htmlspecialchars($_COOKIE['ign']))) {
    setcookie('ign', $developers, $arr_cookie_options);
...
if (!empty(htmlspecialchars($_GET['username']))) {
    include $_SERVER['DOCUMENT_ROOT'] . '/getStats/getVarIndex.php';

    // If statement if hacker.php is allowed to load.
    if (!empty($getUser) && !array_key_exists('error', $getUser) && array_key_exists('profile_id', $getUser) && (($generalPvpHeadshotRatio >= 0.56 && $generalPvpPenetrationRatio >= 0.075) || $generalPvpPenetrationRatio >= 0.11) && $getUser["level"] <= 182) {
        ...
        if (!empty($getUser) && !array_key_exists('error', $getUser) && array_key_exists('profile_id', $getUser)) {
            ...
            if (!in_array($userNamePlatform, $igns)) {
                if (count($igns) == 7) {
                    ...
                    setcookie('ign', $cookiestring, $arr_cookie_options);
                } else {
                    array_push($igns, $userNamePlatform);
                    $cookiestring = implode(";", $igns);
                    setcookie('ign', $cookiestring, $arr_cookie_options);
        ...
        <div class="content">
            ...
            <div class="container-right">
                ...
                <div class="content-container-right">
                    ...
                    <div class="social">
                        <div class="twitter">
                            <a rel="noopener" href="https://twitter.com/R6Lookup" target="_blank">
                        ...
                        <div class="discord">
                            <a rel="noopener" href="https://discord.gg/AhdsnNH" target="_blank">
