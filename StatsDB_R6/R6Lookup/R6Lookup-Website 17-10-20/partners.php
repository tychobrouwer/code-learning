                    ...
                    <ul>
                        <li>
                          ...
                          <div class="main-partner-icon">
                            <a target="_blank" href="https://discord.gg/UGmFmwj">
                                <img src="/dist/img/partners/USE_THIS_FOR_TRANNY.gif" alt="icon" width="200" height="110">
                            </a>
                          </div>
                        </li>
                        <hr>
                        <li>
                          ...
                          <div class="main-partner-icon">
                            <a target="_blank" href="https://discord.com/invite/VPaAmE">
                                <picture width="200" height="110">
                                    <source srcset="/dist/img/partners/inverno-sombrio-wall-b_30.webp" type="image/webp"></source>
                                    <img alt="Black Ice Discord Community" srcset="/dist/img/partners/inverno-sombrio-wall-b_30.jpg">
                                </picture>
                            </a>
                          </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="main-partner-icon">
                                <a target="_blank" href="http://www.tactical-gaming.net">
                                    <img src="/dist/img/partners/tacticalgaming228px.gif" alt="icon" width="200" height="110">
                                </a>
                            </div>
                        </li>
                    </ul>
