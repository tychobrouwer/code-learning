<header class="header-nav">
    <div class="main-nav">
        <a class="logo" href="/" draggable="false">
            <img src="/dist/img/r6_lookup_logo.svg" alt="R6 Lookup">
        </a>
        <?php if (htmlspecialchars($_SESSION['loggedin']) == true) { ?>
            <button class="login" onclick="window.location.href='https://www.r6lookup.com/profile/player/overview'">
                <div class="login-text">
                    <?php echo htmlspecialchars($_SESSION['username']) ?>
                </div>
            </button>
        <?php } else { ?>
            <button class="login" onclick="window.location.href='https://www.r6lookup.com/login'">
                <div class="login-text">
                    Login/Signup
                </div>
            </button>
