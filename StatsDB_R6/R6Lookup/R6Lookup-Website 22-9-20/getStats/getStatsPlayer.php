...
foreach ($operators as $operator) {
    ...
    $operatorsFinal[$operator["id"]]["info"]["images"]["badge"] = "/dist/img/operators/badge/" . $operator["id"];
    $operatorsFinal[$operator["id"]]["info"]["images"]["figure"]["small"] = "/dist/img/operators/figure/" . $operator["id"];
