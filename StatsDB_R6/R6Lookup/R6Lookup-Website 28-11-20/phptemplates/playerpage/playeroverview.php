        ...
        <div class="ranks-overview">
            <div class="current-season">
                ...
                <div class="rank">
                    <div class="current-rank-img">
                        <img src="<?php echo $getUser[0]["rankInfo"]['image'] ?>" alt="rank image" width="90" height="90">
                    </div>
            ...
            <?php for ($seasonprev = 1; $seasonprev <= 4; $seasonprev++) { ?>
                <div class="season">
                    ...
                    <div class="rank">
                        <div class="rank-img">
                            <img draggable="false" src="<?php echo $getUser[$seasonprev]["rankInfo"]['image'] ?>" alt="rank image" width="70" height="70">
                        </div>
                        <div class="rank-info">
                            <p class="season-mmr">
