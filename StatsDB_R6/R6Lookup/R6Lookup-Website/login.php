                ...
                <div class="wrapper">
                    ...
                    <div class="form">
                        <form method="post">
                            ...
                            <input id="input-username" type="text" name="username" class="username-login" placeholder="Type your Email or Password" autocomplete="off" required>
                            ...
                            <input id="input-password" type="password" name="password" class="password-login" placeholder="Type your Password" required>
                ...
                <div class="wrapper">
                    ...
                    <div class="form">
                        <form method="post">
                            ...
                            <input id="input-newusername" class="username" placeholder="Type your username" type="username" name="newusername" autocomplete="off" required>
                            ...
                            <input id="input-newmail" class="mail mail1" placeholder="Type your email" type="email" name="newmail" required>
                            ...
                            <?php } ?>
                            <label for="input-newpassword">Password</label>
                            <input id="input-newpassword" class="password password1" placeholder="Type your password" type="password" name="newpassword" autocomplete="off" min="3" max="300" required>
